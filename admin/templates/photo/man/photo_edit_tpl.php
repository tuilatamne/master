                        ...
                        <div class="upload-file mb-2">
                            ...
                            <?php if (isset($item['file_attach']) && $item['file_attach'] != '') { ?>
                                <div class="file-uploaded mb-2">
                                    <a class="btn btn-sm bg-gradient-primary text-white d-inline-block align-middle rounded p-2" href="<?= UPLOAD_FILE . @$item['file_attach'] ?>" title="Download video hiện tại"><i class="fas fa-download mr-2"></i>Download video hiện tại</a>
                                </div>
                            <?php } ?>
                            <strong class="d-block text-sm"><?= $config['photo']['man_photo'][$type]['file_type_photo'] ?></strong>
                        </div>
                    </div>
                <?php } ?>
                <!-- end -->
