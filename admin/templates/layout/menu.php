        ...
        <nav class="mt-3">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item <?= $active ?>">
                    <a class="nav-link <?= $active ?>" href="index.php" title="Thông tin chung">
                                            ...
                                            <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                                                ...
                                                <ul class="nav nav-treeview">
                                                    <?php if (isset($v['list']) && $v['list'] == true) {
                                                        ...
                                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_list&type=<?= $k ?>" title="Loại sản phẩm"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                                <p>Loại sản phẩm</p>
                                                            </a></li>
                                                    <?php } ?>
                                                    ...
                                                    <?php if (isset($v['brand']) && $v['brand'] == true) {
                                                        ...
                                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_brand&type=<?= $k ?>" title="Thương hiệu"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                                <p>Thương hiệu</p>
                                                            </a></li>
                                                    <?php } ?>
                                ...
                                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <?php if (isset($v['list']) && $v['list'] == true) {
                                            ...
                                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('news', 'man_list', $k, null, 'phrase-1')) $none = "d-none";
                                            if ($com == 'news' && ($act == 'man_list' || $act == 'add_list' || $act == 'edit_list' || $kind == 'man_list' || $kind == 'man_list') && $k == $_GET['type']) $active = "active"; ?>
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=news&act=man_list&type=<?= $k ?>" title="Loại sản phẩm"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Loại sản phẩm</p>
                                                </a></li>
                                        <?php } ?>
                                        <?php if (isset($v['cat']) && $v['cat'] == true) {
