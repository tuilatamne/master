                ...
                <div class="card card-permission card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (isset($value['brand']) && $value['brand'] == true) { ?>
                            <div class="form-group row">
                                <label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-brand-<?= $key ?>">Thương hiệu:</label>
                                <div class="col-md-7">
                                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        ...
                        <?php if (isset($value['color']) && $value['color'] == true) { ?>
                            <div class="form-group row">
                                <label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-color-<?= $key ?>">Màu sắc:</label>
                                <div class="col-md-7">
                                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        ...
                        <?php if (isset($value['size']) && $value['size'] == true) { ?>
                            <div class="form-group row">
                                <label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-size-<?= $key ?>">Size:</label>
                                <div class="col-md-7">
                                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                ...
                if (isset($value['dropdown']) && $value['dropdown'] == true) { ?>
                    <div class="card card-permission card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            <?php if (isset($value['list']) && $value['list'] == true) { ?>
                                <div class="form-group row">
                                    <label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-news-list-<?= $key ?>">Loại sản phẩm:</label>
                                    <div class="col-md-7">
                                        <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
