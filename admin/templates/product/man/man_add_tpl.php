                        ...
                        <div class="card-body">
                            <div class="form-group-category row">
                                ...
                                <?php if (isset($config['product'][$type]['color']) && $config['product'][$type]['color'] == true) { ?>
                                    <div class="form-group col-xl-6 col-sm-4">
                                        <label class="d-block" for="id_color">Màu sắc:</label>
                ...
                <?php if (isset($config['product'][$type]['images1']) && $config['product'][$type]['images1'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            ...
                            $photoDetail1['dimension'] = "Width: " . $config['product'][$type]['width'] . " px - Height: " . $config['product'][$type]['height'] . " px (" . $config['product'][$type]['img_type'] . ")";
                    ...
                    <?php if (isset($config['product'][$type]['sale_price']) && $config['product'][$type]['sale_price'] == true) { ?>
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control format-price sale_price text-sm" name="data[sale_price]" id="sale_price" placeholder="Giá bán" value="<?= (!empty($flash->has('sale_price'))) ? $flash->get('sale_price') : @$item['sale_price'] ?>">
